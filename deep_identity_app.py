...
def build_block3_questions() -> List[Question]:
    ...
    # c1: ВАУ / восприятие
    q.append(Q("c1_q1", "c1", "1) Что в людях вызывает у тебя мгновенный «вау»? И у тебя возникают такие эмоции, абалдеть, ну как так возможно",
               [
    ...
    q.append(Q("c1_q2", "c1", "2) Какие сцены/пространство тебя завораживают больше всего? И у тебя возникают такие эмоции, абалдеть, ну как так возможно",
               [
